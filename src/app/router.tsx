...
const StaffApplicationDetailPage = lazy(() => import("@/features/admin/pages/StaffApplicationDetailPage"));
const StaffApplicationsPage = lazy(() => import("@/features/admin/pages/StaffApplicationsPage"));
const StaffProfilePage = lazy(() => import("@/features/admin/pages/StaffProfilePage"));
const StaffMerchantsPage = lazy(() => import("@/features/admin/pages/StaffMerchantsPage"));
const StaffUserProfilePage = lazy(() => import("@/features/admin/pages/StaffUserProfilePage"));
const AffiliateLinkPage = lazy(() => import("@/features/affiliateLink/pages/AffiliateLinkPage"));
const AffiliateRedirectPage = lazy(() => import("@/features/affiliateLink/pages/AffiliateRedirectPage"));
...
const MerchantDetailPage = lazy(() => import("@/features/customer/pages/MerchantDetailPage"));
...
const MerchantRestaurantPage = lazyNamed(() => import("@/features/merchantPortal/pages/MerchantRestaurantPage"), "MerchantRestaurantPage");
const MerchantViewStatisticsPage = lazyNamed(() => import("@/features/merchantPortal/pages/MerchantViewStatisticsPage"), "MerchantViewStatisticsPage");
const MerchantOrdersPage = lazy(() => import("@/features/merchantPortal/pages/MerchantOrdersPage"));
const MerchantCreateOrderPage = lazy(() => import("@/features/merchantPortal/pages/MerchantCreateOrderPage"));
const MerchantProfilePage = lazy(() => import("@/features/merchantPortal/pages/MerchantProfilePage"));
