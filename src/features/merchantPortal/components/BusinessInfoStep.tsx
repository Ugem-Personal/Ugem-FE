...
export function BusinessInfoStep({ register, errors, setValue, watch }: Props) {
  ...
  return (
    <section className="relative overflow-hidden rounded-4xl border border-slate-200/80 dark:border-white/10 bg-white/85 dark:bg-slate-900/90 p-6 shadow-2xl shadow-cyan-950/10 backdrop-blur-xl md:p-8 transition-colors duration-300">
      <div className="pointer-events-none absolute -right-12 -top-12 h-40 w-40 rounded-full bg-cyan-200/30 dark:bg-cyan-500/10 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-14 -left-14 h-44 w-44 rounded-full bg-amber-200/20 dark:bg-indigo-500/10 blur-3xl" />

      <div className="relative">
        <div className="mb-8 flex items-start gap-4">
          <div className="grid h-14 w-14 shrink-0 place-items-center rounded-2xl bg-cyan-100 dark:bg-cyan-500/20 text-cyan-800 dark:text-cyan-400 shadow-sm border border-cyan-200/50 dark:border-cyan-500/30">
            <Store className="h-7 w-7" />
          </div>

          <div>
            <span className="inline-flex rounded-full border border-cyan-200 dark:border-cyan-500/30 bg-cyan-50 dark:bg-cyan-500/10 px-3 py-1 text-xs font-bold uppercase tracking-[0.18em] text-cyan-800 dark:text-cyan-400">
              Merchant onboarding
            </span>
        ...
        <div className="space-y-6">
          <div className="grid gap-5 md:grid-cols-2">
            <label className="block space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  className="h-12 w-full rounded-2xl border border-slate-200 dark:border-white/10 bg-white/90 dark:bg-slate-800/90 pl-12 pr-4 text-sm font-medium text-slate-900 dark:text-white shadow-sm outline-none transition placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/15"
              ...
              <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-12 w-full rounded-2xl border border-slate-200 dark:border-white/10 bg-white/90 dark:bg-slate-800/90 pl-12 pr-4 text-sm font-medium text-slate-900 dark:text-white shadow-sm outline-none transition focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/15"
                ...
                <input
                  ...
                  className="h-12 w-full rounded-2xl border border-slate-200 dark:border-white/10 bg-white/90 dark:bg-slate-800/90 px-4 text-sm font-medium text-slate-900 dark:text-white shadow-sm outline-none transition focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/15"
                  ...
                  <button
                    ...
                    className={`rounded-full border px-3 py-1 text-xs font-bold transition ${
                      openingHours === preset.value
                        ...
                        : "border-slate-200 dark:border-white/10 bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:border-cyan-300 hover:bg-cyan-50 dark:hover:bg-slate-700"
                    }`}
                  >
                    {preset.label}
                  </button>
          ...
          <div className="space-y-2">
            <span className="text-sm font-bold text-slate-800 dark:text-slate-200">Logo quán *</span>
            <div className="flex items-start gap-4">
              <div className="flex-1">
                <div className="relative flex items-center gap-3">
                  ...
                  />
                  <label
                    className="flex cursor-pointer items-center justify-center gap-2 rounded-2xl border border-slate-200 dark:border-white/10 bg-white/90 dark:bg-slate-800/90 px-4 py-3 text-sm font-medium text-slate-700 dark:text-slate-200 shadow-sm transition hover:bg-slate-50 dark:hover:bg-slate-700 focus-within:ring-4 focus-within:ring-cyan-500/15"
              ...
              {(() => {
                ...
                return (
                  <div className="h-16 w-16 shrink-0 overflow-hidden rounded-xl border border-slate-200 dark:border-white/10 shadow-sm">
                    <img
                      src={src}
                      alt="Logo quán"
                  ...
                  className={`
                    ...
                    ${
                      priceRange === item
                        ...
                        : "border-slate-200 dark:border-white/10 bg-white/90 dark:bg-slate-800/90 text-slate-700 dark:text-slate-200 hover:border-cyan-300 hover:bg-cyan-50 dark:hover:bg-slate-700"
                    }
                  `}
                  onClick={() =>
          ...
          <label className="block space-y-2">
            ...
            <textarea
              className="min-h-32 w-full resize-none rounded-2xl border border-slate-200 dark:border-white/10 bg-white/90 dark:bg-slate-800/90 px-4 py-3 text-sm font-medium leading-6 text-slate-900 dark:text-white shadow-sm outline-none transition placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/15"
          ...
          <div className="rounded-3xl border border-cyan-100 dark:border-cyan-500/30 bg-cyan-50/80 dark:bg-cyan-950/40 p-5 text-cyan-950 dark:text-cyan-100">
            <div className="flex gap-3">
              <div className="grid h-10 w-10 shrink-0 place-items-center rounded-2xl bg-cyan-100 dark:bg-cyan-500/20 text-cyan-800 dark:text-cyan-400">
